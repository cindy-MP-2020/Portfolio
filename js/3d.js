...
window.onload = function() {
    ...
    for (i = 0; i < aLi.length-3; i++) {
        ...
        aLi[i].onclick = function() {
            ...
            oFrame.innerHTML = '<img src="img/3D Medeling/' + (this.index + 1) + '.JPG" />';
            ...
            with(oImg.style) {
                height = width = '100%';
                marginTop = 50 + document.documentElement.scrollTop + 'px'
            }
            startMove(oFrame, { opacity: 100, left: iLeft, top: iTop, width: iWidth, height: iHeight });
            close.style.top = 40 + document.documentElement.scrollTop + 'px';
            oBg.style.display = 'block';
            oBg.style.height = $(document).height() + 'px';
    ...
    //         oFrame.innerHTML = '<img src="img/photoshop/' + iNow + '.jpg" width="100%" height="100%" />';
    //     };
